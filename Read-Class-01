Fabio Alvarez										Aug 29,2022
	...
	As it relates to networking, it is important to be able to distinguish between the admin from the regular users. The users have restricted permissions whereas the admin has full control over the domain. Windows 2019 would be considered an admin in this case, they would be responsible for group policies, adding and removing users from a created domain, and many  more responsibilities. Windows 10 is a very typical OS, that includes all the functionality of a home computer, it just lacks the ability to manage other computers on a large scale. 
